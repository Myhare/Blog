          ...
          <v-card class="animated zoomIn blog-card mt-5">
            <div class="author-wrapper">
              ...
              <v-avatar size="110">
                <img
                    class="author-avatar"
                    :src="blogInfo.websiteConfig.userAvatar"
                />
              </v-avatar>
...
import EasyTyper from "easy-typer-js";  // 打字机效果
export default {
  components: {
    Swiper
  },
  ...
  methods: {
    ...
    infiniteHandler($state) {
      ...
      this.$axios
          .get("/api/articles")
          .then(({ data }) => {
            // console.log('成功查询主页博客,data:');
            // console.log(data);
            if (data.data.length) {
              // 去除markdown标签
              // console.log('去除markdown标签');
  ...
  computed: {
    ...
    cover() {
      ...
      if (flag){
        cover = 'http://www.static.mingzib.xyz/blogGetDefaultFile/deafaultArticleCover.png';
      }
