...
export default {
  ...
  methods: {
    ...
    connect() {
      var that = this;
      // console.log('websocket的url:' + this.blogInfo.websiteConfig.websocketUrl);
      // this.websocket = new WebSocket('ws://localhost/chatRoom');
      // this.websocket = new WebSocket('ws://192.168.230.1/chatRoom');
