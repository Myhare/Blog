...
export default {
  ...
  methods: {
    ...
    listLogs() {
      ...
      this.$store.dispatch('log/logList',queryInfo)
        .then(({ data }) => {
          // console.log('查询成功');
          // console.log(data);
          this.logList = data.recordList;
    ...
    deleteLog(id) {
      ...
      if (id != null) {
        ...
        logIdList = this.logIdList;
      }
      // 删除
      this.$store.dispatch('log/delLogList',logIdList)
        .then((data) => {
          console.log('删除日志成功,data:');
          console.log(data);
          if (data.flag){
            this.$notify.success({
              title: "成功",
